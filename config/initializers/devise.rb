...
Devise.setup do |config|
  ...
  # config.secret_key =
  # 'f35b7c9a42749906b97d56106104f2cc5ac30acb3f2353ff3f12ae55162943583c6842e6bbe
  # 65411e09a851a2af11066ea412f93a386b4a1c7735bcb07c307a8'
  ...
  # only for the given strategies, for example, `config.params_authenticatable =
  # [:database]` will
  ...
  # (e.g. a value of 20 is already extremely slow: approx.
  # 60 seconds for 1 calculation).
  config.stretches = Rails.env.test? ? 1 : 10

  # Setup a pepper to generate the encrypted password.
  # config.pepper =
  # '5d3426adf7240369825def10b0ac4419f06815d7cb3bc64734ad3f28eb32f84c5209f22f520
  # c4fa653d010613e3e4ad7e9e0c0d76056f51d8fa1f4a826507068'
  ...
  # 20 for default behavior) and :restful_authentication_sha1
  ...
  # config.omniauth :twitter ENV['TWITTER_API_KEY'], ENV['TWITTER_API_KEY']
